...
namespace RPG.Movement 
{
    public class Mover : MonoBehaviour, IAction, ISaveable
    {
        ...
        void Update()
        {
            _navMashAgent.enabled = !_health.IsDead();
            UpdateAnimator();
        }
        ...
        {
            _navMashAgent.destination = destination;
            _navMashAgent.speed = _maxSpeed * Mathf.Clamp01(speedFraction); 
        ...
        {
            Vector3 velocity = _navMashAgent.velocity;
